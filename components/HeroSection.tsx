...
const MOBILE_SLIDES: MobileSlide[] = [
  ...
  },
  {
    ...
    headline: "Goat Milk Coffee De-Tan Soap",
    subHeadline: "A Coffee-Inspired Exfoliating Bath Bar",
    description: "A coffee-infused goat milk soap bar with a gentle scrub feel for refreshed-looking skin and an energising bath routine.",
  ...
  {
    id: 3,
    badge: "🥭 MANGO BUTTER & SEA CLAY CLEANSING",
    headline: "Mango Butter Mud Sea Clay Soap",
    subHeadline: "Handcrafted Bath Bar for Refreshing Daily Cleansing",
    description: "A handcrafted bath bar made with mango butter and sea clay-inspired cleansing comfort for skin that feels clean, soft and refreshed after every bath.",
  ...
  {
    id: 4,
    badge: "🌿 BOTANICAL HERBAL CARE & GENTLE RITUALS",
    headline: "Herbal Waxing & Skin Care Powder",
    subHeadline: "Natural Botanical Body Care Solution",
    description: "Formulated with carefully selected herbal powders for gentle body care routines, leaving skin feeling soft, smooth and naturally cared for.",
