      ...
      <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6">
        ...
        <div className="text-center flex flex-col items-center justify-center my-1 md:my-0">
          <motion.h3
            ...
            className="text-lg sm:text-2xl md:text-3xl font-extrabold tracking-wider uppercase font-serif text-transparent bg-clip-text bg-gradient-to-b from-yellow-200 via-gold to-amber-500 drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)]"
            style={{
              textShadow: '0 2px 8px rgba(0,0,0,0.5), 0 0 12px rgba(245,166,35,0.3)',
            }}
          >
            CHOOSE ANY WELLNESS COMBO
          </motion.h3>
          <p className="text-[10px] sm:text-xs font-sans tracking-widest text-cream-light/90 font-medium uppercase mt-0.5">
            Handcrafted Herbal Care &amp; Natural Botanical Formulations
          </p>
        </div>

        {/* Right White Pill Badge: ⚡ 1 FREE HERBAL SOAP INCLUDED ⚡ */}
        <motion.div
          whileHover={{ scale: 1.03 }}
        ...
        >
          <div className="inline-flex items-center space-x-2 px-5 py-2 sm:py-2.5 rounded-full bg-white text-forest shadow-xl border border-gold/30 font-bold text-xs sm:text-sm tracking-wide uppercase transition-all duration-300">
            ...
            <span className="text-forest font-extrabold">1 FREE HERBAL SOAP INCLUDED</span>
