...
export default function AdminDashboard() {
  ...
  const [sectionConfig, setSectionConfig] = useState<any>({
    ...
    faqSection: {
      ...
      items: [
        { question: '1. Are PurePlush products 100% natural?', answer: 'Yes. PurePlush products are made using carefully selected herbal and naturally derived ingredients. They are free from harsh chemicals such as parabens, sulfates (SLS/SLES), silicones, and artificial colors, making them a gentler choice for your skin and hair.' },
        { question: '2. Are PurePlush products suitable for all skin and hair types?', answer: 'Yes. Our products are formulated for most skin and hair types, including normal, oily, dry, and combination skin. Since every individual is different, we recommend performing a patch test before first use.' },
        { question: '3. Are PurePlush products safe for sensitive skin?', answer: 'Our herbal formulations are designed to be gentle on the skin. However, if you have highly sensitive skin or known allergies, we recommend a patch test 24 hours before use.' },
        { question: '4. How long does it take to see visible results?', answer: 'Results vary depending on the individual and consistent usage. Many customers notice improvements within 3–6 weeks when used regularly as directed.' },
        { question: '5. Can I use PurePlush products every day?', answer: 'Yes. Most PurePlush products are gentle enough for daily use. Please follow the usage instructions mentioned on each product for the best results.' },
        { question: '6. Are PurePlush products cruelty-free?', answer: 'Yes. PurePlush products are cruelty-free, and we do not test our products on animals.' },
        { question: '7. Why should I choose PurePlush over other herbal brands?', answer: 'PurePlush combines traditional herbal ingredients with modern manufacturing standards to create high-quality personal care products that are gentle, effective, and free from harsh chemicals. Our focus is on natural care, quality ingredients, and customer satisfaction.' },
        { question: '8. Are there any side effects?', answer: 'PurePlush products are made with herbal ingredients and are generally well tolerated. However, as with any skincare or haircare product, individual reactions may vary. If irritation occurs, discontinue use and consult a healthcare professional if needed.' },
        { question: '9. Do you offer Cash on Delivery (COD) and fast shipping?', answer: 'Yes. We offer Cash on Delivery (where available) along with secure online payment options. Most orders are delivered within 3–7 business days, depending on your location.' },
        { question: '10. What if I\'m not sure which PurePlush product is right for me?', answer: 'Our product pages include detailed information about ingredients, benefits, and usage to help you choose. If you still need assistance, our customer support team will be happy to recommend the best PurePlush product based on your needs.' }
      ]
    }
  });
